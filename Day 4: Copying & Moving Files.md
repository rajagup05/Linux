...
**Lab:** Copy note1.txt to note1_copy.txt. Rename note2.txt to important.txt. Move all .txt files into a new Notes sub-directory.  Please acknowledge the message
